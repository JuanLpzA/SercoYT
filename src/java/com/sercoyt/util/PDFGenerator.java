...
public class PDFGenerator {
    ...
    public static void generarBoleta(Venta venta, List<DetalleVenta> detalles, OutputStream out) 
        ...
        addCell(infoTable, String.valueOf(venta.getIdVenta()), NORMAL_FONT);
        ...
        for (DetalleVenta detalle : detalles) {
            addCell(detallesTable, productoDao.obtenerNombreProducto(detalle.getIdProducto()), NORMAL_FONT);
        ...
        // Pie de página
        Paragraph footer = new Paragraph("\n\nGracias por su compra!", NORMAL_FONT);
