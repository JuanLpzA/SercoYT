<%-- 
    Document   : despacho
    Created on : 10 jul. 2025, 22:04:36
    Author     : Arrunategui
--%>
    ...
    <body>
            ...
            <div class="dashboard-content">
                ...
                <div class="dashboard-main">
                    ...
                    <div class="section-header">
                        <h4>Gestión de Despacho</h4>
                        <div class="header-actions">
                            <div class="btn-group" role="group">
                                <a href="${pageContext.request.contextPath}/DespachoControlador?accion=listarOnline" 
                                   class="btn ${filtroActivo eq 'online' ? 'btn-primary' : 'btn-outline-primary'}">
                                    <i class="fas fa-globe"></i> Ventas Online
                                </a>
                                <a href="${pageContext.request.contextPath}/DespachoControlador?accion=listarPresencial" 
        ...
        <script>
            const AppContext = {
                ...
                endpoints: {
                    despacho: {
                        cambiarEstado: '${pageContext.request.contextPath}/DespachoControlador?accion=cambiarEstado',
                        obtenerDetalles: '${pageContext.request.contextPath}/DespachoControlador?accion=obtenerDetalles&idVenta='
                    }
                }
            };
        </script>
        <script src="${pageContext.request.contextPath}/js/despacho.js"></script>
    </body>
</html>